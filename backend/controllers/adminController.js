...
const appoimtmentsAdmin = async (req, res) => {
    try {
...
// API to get dashboard data at admin panel
...
export {addDoctor, loginAdmin, allDoctors, appoimtmentsAdmin, appointmentCancel, adminDashboard}